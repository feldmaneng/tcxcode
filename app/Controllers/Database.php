...
class Database extends BaseController {
	...
	public function index()
	{
		...
		echo"<h1>Various Limited Use Functions</h1>";
			...
			echo "<LI><a href=" . site_url('/contactsID/lookup') . ">Submit an CSV with just emails to find CONTACT IDS</a></LI>";
...
/* 				
    ...
    function contacts()
	{
		...
		$crud->setUniqueId('april302025');
		$crud->columns (['ContactID','GivenName','FamilyName','NativeName','Nickname','Mobile','Company','Email','Active']);
...
//		$crud->fieldType('Active','boolean'); //'enum',['No','Yes']);
   ...
   function companies()
   {
		...
		$crud->columns (['CompanyID','Name','CN_Name','ParentID', 'StandardName']);
