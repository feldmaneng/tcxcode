...
//this determines how many rows the sheet has
			...
			$SESSION=$results[$n]["Session"];
				...
				if($event == 'Mesa'){
					$pdf->Image($_SERVER["DOCUMENT_ROOT"].'/images/TestConXletterframe2.png', 0, 0, 279, 210, 'PNG', '', '',true,300, '', false, false, 0, false, false, false);
				...
				if($event == 'China'){
				  ...
				  $pdf->SetFont('times', '', 18);
				   ...
				   $pdf->MultiCell(100, 25,"for the presentation", 0, 'C', 0, 0, $x,$y+3.9*$z, true);
					...
					$style = array('width' => 0.5, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)); 
					$pdf->Line( $x3+15+4.4, 170,25.58+63+4.4, 168, $style = array() );
					$pdf->Line( $x3+88+4.4, 170,25.58+136+4.4, 168, $style = array() );
					$pdf->Line( $x3+161+4.4, 170,25.58+209+4.4, 168, $style = array() );
					$pdf->SetFont('times', '', 12);
					$pdf->MultiCell(60, 23,$chair1." \nChina Program Chair", 0, 'L', 0, 0, $x3+17.7+4.4, 168, true);
					$pdf->MultiCell(60, 23,$chair2." \nChina General Chair", 0, 'L', 0, 0, $x3+90.7+4.4, 168, true);
					$pdf->MultiCell(60, 23,"Ira Feldman \nTestConX General Chair", 0, 'L', 0, 0, $x3+163.7+4.4, 168, true);
				...
				if($event == 'Korea'){
					...
					$pdf->Image($_SERVER["DOCUMENT_ROOT"].'/images_new/TestConXKoreaOrangeFrameA4r2.png', 0, 0,300,207, 'PNG', '', '',true,300, '', false, false, 0, false, false, false);
					$x=102-2;
					$y=60;
					$z=10;
					$x2=49.7-2;
