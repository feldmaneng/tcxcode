...
public function Guestcrudkorea()
{
	...
	$crud->fields(['EventYear','Email','GivenName','FamilyName','ChineseName','Tutorial','InvitedByCompanyID','Company','Address1','Address2','City','State','Country','Mobile','ToPrint','PrintTime']);
